...
python inference1.py --test_dataset "people_knowledge.json" --dataset_name people_knowledge --meta_save_path output --model_name "$MODEL_NAME" --conflict_type ie --eval_type mcq --ty Career --oringin f
