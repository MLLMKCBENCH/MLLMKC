...
python inference1_d.py --test_dataset "people_knowledge.json" --dataset_name people_knowledge --meta_save_path detection --model_name "$MODEL_NAME" --conflict_type ie --eval_type openqa --ty Career --oringin f
