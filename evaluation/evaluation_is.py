    ...
    with open(file_a_path, 'r', encoding='utf-8') as a_file:
        for line in a_file:
            try:
                ...
                if a_prediction == a_data.get("mcq_disanswer1"):
                    filtered_count += 1
                    continue
                ...
                b_disanswer1=b_item.get('mcq_disanswer1')
                # 提取答案
        ...
        for line in a_file:
            try:
                ...
                if a_prediction == a_data.get("mcq_disanswer1"):
                    filtered_count += 1
                    continue
                if a_prediction == a_data.get("mcq_disanswer2"):
                    filtered_count += 1
                    continue
                ...
                b_prediction = b_item.get('prediction')
                b_disanswer1=b_item.get('mcq_disanswer1')
                b_disanswer2=b_item.get('mcq_disanswer2')
                # 提取答案
                a_answer = extract_answer(a_prediction)
                b_answer = extract_answer(b_prediction)
